...
name=input("\U0001F628 Enter the name\U0001F628****")
...
def hangman(secret_word):
    ...
    * Har round ke baad, user ko uska guess kiya hua partial word
    ...
    print ("\U0001F493 WELCOME TO Hangman GAME! \U0001F493")
    print( "I am thinking of a word that is " + str(len(secret_word)) + " letters long.")
    print("***"+name+"***")
    print ("")
    j=0
    while j<1:
        choice=input("\U0001F495 which level do you want to play..?\U0001F495\na)\tEasy\nb)\tMedium\nc)\tHard\n\nyour choice a, b, c \n")
        if choice=="a":
            remaining_lives=8
    ...
    while (remaining_lives>0):
        ...
        if letter in secret_word:
            ...
            print ("\U0001F49C Good guess \U0001F49C" + get_guessed_word(secret_word, letters_guessed))
            print ("")
            print(letters_guessed)
            if is_word_guessed(secret_word, letters_guessed)== True:
                print (" * \U0001F496 * Congratulations, you won! *\U0001F496 * ")
                print( "")
                break
        else:
            print (" \U0001F63A Oops! That letter is not in my word \U0001F63A :" + get_guessed_word(secret_word, letters_guessed))
            ...
            if c==len(image_selection):
                print(" \U0001F620 You are out in this game plz try again \U0001F620")
                break
    else:
...
hangman(secret_word)
def play():
    print("\U0001F928...A Do you want play return \U0001F928...")
